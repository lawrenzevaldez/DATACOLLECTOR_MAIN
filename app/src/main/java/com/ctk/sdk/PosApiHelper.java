...
public class PosApiHelper {
    ...
    private PosApiHelper(Context context) {
    ...
    public void connectPayService() {
        ...
        mPosPayKernel.initPaySDK(mContext, mConnectCallback);
    ...
    public static PosApiHelper getInstance(Context context) {
        if (null == mInstance) {
            mInstance = new PosApiHelper(context);
        }
        return mInstance;
    }
